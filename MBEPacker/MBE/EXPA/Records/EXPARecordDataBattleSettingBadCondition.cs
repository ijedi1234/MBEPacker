...
{
    public class EXPARecordDataBattleSettingBadCondition : EXPARecord
    {
        public int Value1 { get; set; }
        public int Value2 { get; set; }
        public int Value3 { get; set; }

        public EXPARecordDataBattleSettingBadCondition() : base() { }

        public EXPARecordDataBattleSettingBadCondition(byte[] rawRecord) : base(rawRecord)
        {
        ...
        public EXPARecordDataBattleSettingBadCondition(JsonObject json) : base(json)
        {
