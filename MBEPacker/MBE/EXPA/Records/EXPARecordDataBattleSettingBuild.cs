...
{
    public class EXPARecordDataBattleSettingBuild : EXPARecord
    {
        ...
        public EXPARecordDataBattleSettingBuild() : base() { }

        public EXPARecordDataBattleSettingBuild(byte[] rawRecord) : base(rawRecord)
        {
        ...
        public EXPARecordDataBattleSettingBuild(JsonObject json) : base(json)
        {
