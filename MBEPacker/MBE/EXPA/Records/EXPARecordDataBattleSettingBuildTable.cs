...
{
    public class EXPARecordDataBattleSettingBuildTable : EXPARecord
    {
        ...
        public EXPARecordDataBattleSettingBuildTable() : base() { }

        public EXPARecordDataBattleSettingBuildTable(byte[] rawRecord) : base(rawRecord)
        {
        ...
        public EXPARecordDataBattleSettingBuildTable(JsonObject json) : base(json)
        {
